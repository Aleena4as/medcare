$(document).ready(function () {
   ...
   $(document).on("click", ".addmember-btn", function () {
      ...
      if (memberlimit == allowedlimit) {
         $(".membersExceededError").append("<p>Note: This booking is limited to four members only</p>");
         // alert("You have Limited to have " + memberlimit + "members only");
      } else {
         $(".membersExceededError").empty();
         $(".members-panel").append(
            '<div class="memberDetails" id="memberContent' +
               memberlimit +
               '">\
          <div class="row">\
              <div class="col-12">\
                  <div class="section-title">\
                      <p class="memberCount">Member ' +
               memberlimit +
               '</p>\
                      <p id="deleteMember' +
               memberlimit +
              ...
              <div class="col-12 col-md-6">\
                  <div class="form-group inputIconPlacer">\
                      ...
                      <input type="text" class="form-control datefixerDoB famDob"\
         ...
         $(".previewMemberPanel").append(
            '<div class="previewDetails" id="previewContents' +
               memberlimit +
               '">\
