   ...
   var calendar = $("#calendar").fullCalendar({
      eventRender: function (event, element, view) {
         ...
         if (event.calendar == "Sharjah") {
            element.css("background-color", "#97005e");
      ...
      select: function (startDate, endDate, jsEvent, view) {
         ...
         var HTMLContent =
            ...
            '","' +
            "Covid test @Home" +
            '")\'> <a tabindex="-1" href="#">Add Covid test @Home</a></li>' +
            "<li onclick='newEvent(\"" +
            startDate +
            '","' +
            endDate +
            '","' +
            "Lab test @Home" +
            '")\'> <a tabindex="-1" href="#">Add Lab test @Home</a></li>' +
            "<li onclick='newEvent(\"" +
            startDate +
            '","' +
            endDate +
            '","' +
            "Vaccination @Home" +
            '")\'> <a tabindex="-1" href="#">Add Vaccination @Home</a></li>' +
            "<li onclick='newEvent(\"" +
            startDate +
            '","' +
            endDate +
            '","' +
            "Nurse @Home" +
            '")\'> <a tabindex="-1" href="#">Add Nurse @Home</a></li>' +
            "<li onclick='newEvent(\"" +
            startDate +
            '","' +
            endDate +
            '","' +
            "Doctor @Home" +
            '")\'> <a tabindex="-1" href="#">Add Doctor @Home</a></li>' +
            "<li onclick='newEvent(\"" +
            startDate +
            '","' +
            endDate +
            '","' +
            "Physio @Home" +
            '")\'> <a tabindex="-1" href="#">Add Physio @Home</a></li>' +
            '<li class="divider"></li>' +
